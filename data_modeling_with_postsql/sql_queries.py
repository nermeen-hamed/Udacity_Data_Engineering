...
songplay_table_create = ("""
    CREATE TABLE IF NOT EXISTS songplays (
        ...
        start_time TIMESTAMP REFERENCES time (start_time) UNIQUE, 
        user_id INT REFERENCES users (user_id) UNIQUE, 
        level VARCHAR, 
        song_id VARCHAR REFERENCES songs (song_id) UNIQUE, 
        artist_id VARCHAR REFERENCES artists (artist_id) UNIQUE, 
